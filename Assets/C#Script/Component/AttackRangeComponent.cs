...
{
    public class AttackRangeComponent : EntityComponent
    {
        public List<GameObject> GetRangeFloor() => blocks;
        List<GameObject> blocks=new List<GameObject>();
        [Header("盒状")]
        public bool box;
        private float _baoliu;
        ...
        private void Update()
        {
            ...
            {
                RangeMove.z = -Mathf.Abs(_baoliu);
            }
            else if (90 < transform.eulerAngles.y && transform.eulerAngles.y < 270)
            {
                RangeMove.z = -Mathf.Abs(_baoliu);
            }
            else
